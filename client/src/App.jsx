    ...
    if (user) {
      ...
      eventSource.addEventListener("notification", (event) => {
        ...
        if (notification.type === "message" && !pathnameRef.current.includes("/messages")) {
            ...
            toast.success(`${notification.sender.full_name} liked your comment`);
        } else if (notification.type === "comment") {
            toast.success(`${notification.sender.full_name} commented on your post`);
        } else if (notification.type === "reply") {
            toast.success(`${notification.sender.full_name} replied to your comment`);
        } else if (notification.type === "repost") {
            toast.success(`${notification.sender.full_name} reposted your post`);
        }
      });
