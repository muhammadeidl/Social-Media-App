    ...
    >
      ...
      <div className="p-4 pt-0 border-t border-gray-50/50 dark:border-slate-800 mt-auto flex flex-col gap-2">
        <button
          ...
          ${isFollowing 
            ? "bg-gray-100 dark:bg-slate-800 text-gray-700 dark:text-gray-200 hover:bg-red-50 hover:text-red-600 dark:hover:bg-red-500/10 dark:hover:text-red-400 group/follow" 
            : "bg-indigo-600 hover:bg-indigo-700 text-white shadow-sm active:scale-95 group/follow"
          }`}
        >
          {isFollowing ? (
            <>
              <UserCheck className="w-4 h-4 group-hover/follow:hidden" />
