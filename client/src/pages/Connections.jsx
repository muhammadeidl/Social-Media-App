import { Users, MessageSquare, ArrowRight, UserCheck, UserPlus, Hourglass, Search } from "lucide-react";
...
const Connections = () => {
  ...
  const dataArray = useMemo(
    () => [
      ...
      { label: "Pending", value: pendingConnections, icon: Hourglass, color: "from-amber-500 to-orange-500" },
      { label: "Connections", value: connections, icon: UserPlus, color: "from-emerald-500 to-teal-500" },
    ],
              ...
              <div className="grid grid-cols-2 gap-3 mt-6">
                ...
                {currentTab === "Pending" && (
                  <button
                    ...
                    className="py-2.5 text-xs font-bold rounded-xl bg-indigo-50 dark:bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-100 dark:hover:bg-indigo-500/20 transition-all active:scale-95 cursor-pointer"
                  >
                    Accept
                  </button>
                )}
                ...
                {currentTab === "Connections" && (
                  <button
                    ...
                    className="flex items-center justify-center gap-1.5 py-2.5 text-xs font-bold rounded-xl bg-indigo-600 text-white hover:bg-indigo-700 transition-all active:scale-95 cursor-pointer shadow-lg shadow-indigo-600/20"
                  >
